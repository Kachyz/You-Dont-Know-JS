# No sabes JS (serie de libros)

Esta es una serie de libros que profundizan en el núcleo del lenguaje JavaScript. La primera edición de la serie se encuentra completa
